...
from .handlers import ChatCompletionsHandler, MessagesHandler, ResponsesHandler, TokenCountHandler
...
async def create_chat_completion(
    ...
    """Create a chat completion (OpenAI-compatible). Returns JSON or SSE stream."""
